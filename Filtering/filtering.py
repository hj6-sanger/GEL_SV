...
This script extracts SVs in bedpe format from VCF files using vcfToBedpe.
...
This script takes an overlap of SVs in probands with those in their parents to get de novo SVs. 
'''
